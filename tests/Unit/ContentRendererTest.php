...
test('renders basic markdown to html', function () {
...
test('renders markdown with bold text', function () {
    $renderer = new ContentRenderer();
...
test('renders markdown with italic text', function () {
    $renderer = new ContentRenderer();
...
test('renders markdown with links', function () {
    $renderer = new ContentRenderer();
...
test('renders code blocks with syntax highlighting', function () {
    $renderer = new ContentRenderer();
    $code = "```php\n<?php echo 'Hello';\n```";
...
test('strips html when configured', function () {
...
test('allows html when not configured to strip', function () {
