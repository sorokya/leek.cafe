...
<a class="nav-link {{ request()->is('projects*') ? 'is-active' : '' }}" href="{{ route('projects.index') }}"
...
<a class="nav-link {{ request()->is('posts*') ? 'is-active' : '' }}" href="{{ route('posts.index') }}"
    aria-label="Posts" title="Posts">
...
<a class="nav-link {{ request()->is('media*') ? 'is-active' : '' }}" href="{{ route('media.index') }}"
...
@auth
    <a class="nav-link {{ request()->is('settings*') ? 'is-active' : '' }}" href="{{ route('profile.show-settings') }}"
