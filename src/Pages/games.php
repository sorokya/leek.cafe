...
$n64Games = [
    [
        ...
        'year' => 1998,
        'cover' => '/img/games/oot-cover.webp',
        'rating' => 5.0,
    ...
    [
        ...
        'year' => 2000,
        'cover' => '/img/games/mm-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Super Mario 64',
        'year' => 1996,
        'cover' => '/img/games/sm64-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Super Smash Bros.',
        'year' => 1999,
        'cover' => '/img/games/smash64-cover.webp',
        'rating' => 4.5,
    ],
];
...
$ps2Games = [
    [
        ...
        'year' => 2001,
        'cover' => '/img/games/jak1-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Jak II',
        'year' => 2003,
        'cover' => '/img/games/jak2-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Jak 3',
        'year' => 2004,
        'cover' => '/img/games/jak3-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Kingdom Hearts',
        'year' => 2002,
        'cover' => '/img/games/kh1-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Kingdom Hearts II',
        'year' => 2006,
        'cover' => '/img/games/kh2-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'SSX 3',
        'year' => 2003,
        'cover' => '/img/games/ssx3-cover.webp',
        'rating' => 4.5,
    ],
    [
        'title' => 'Bully',
        'year' => 2006,
        'cover' => '/img/games/bully-cover.webp',
        'rating' => 4.5,
    ],
    [
        'title' => 'GTA: 3',
        'year' => 2001,
        'cover' => '/img/games/gta3-cover.webp',
        'rating' => 4.5,
    ],
    [
        'title' => 'GTA: Vice City',
        'year' => 2002,
        'cover' => '/img/games/gta-vc-cover.webp',
        'rating' => 4.5,
    ],
    [
        'title' => 'GTA: San Andreas',
        'year' => 2004,
        'cover' => '/img/games/gta-sa-cover.webp',
        'rating' => 5.0,
    ],
];
...
$snesGames = [
    [
        ...
        'year' => 1990,
        'cover' => '/img/games/smw-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Super Mario: All-Stars',
        'year' => 1993,
        'cover' => '/img/games/smas-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Donkey Kong Country',
        'year' => 1994,
        'cover' => '/img/games/dkc-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Mickey Mania',
        'year' => 1994,
        'cover' => '/img/games/mickey-mania-cover.webp',
        'rating' => 4.5,
    ],
];
...
$gameCubeGames = [
    [
        ...
        'year' => 2003,
        'cover' => '/img/games/ww-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Zelda: Twilight Princess',
        'year' => 2006,
        'cover' => '/img/games/tp-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Super Mario Sunshine',
        'year' => 2002,
        'cover' => '/img/games/sms-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => "Luigi's Mansion",
        'year' => 2001,
        'cover' => '/img/games/luigi-mansion-cover.webp',
        'rating' => 5.0,
    ],
];
...
$dreamcastGames = [
    [
        ...
        'year' => 1998,
        'cover' => '/img/games/sonic-adventure-cover.webp',
        'rating' => 4.5,
    ],
    [
        'title' => 'Sonic Adventure 2',
        'year' => 2001,
        'cover' => '/img/games/sonic-adventure-2-cover.webp',
        'rating' => 4.5,
    ],
];
...
$gbaGames = [
    [
        ...
        'year' => 2004,
        'cover' => '/img/games/pokemon-fr-cover.webp',
        'rating' => 5.0,
    ],
    [
        'title' => 'Pokémon Emerald',
        'year' => 2005,
        'cover' => '/img/games/pokemon-emerald-cover.webp',
        'rating' => 5.0,
    ],
];
