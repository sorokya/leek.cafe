...
'posts.update','posts.upload-images','theme.toggle','image.serve','image.serve-thumbnail',
'storage.local',);
...
'errors.500','login','pagination::default','post.create','post.delete-confirm',
'post.edit','post.index','post.show','set-password','settings',
'vendor.pagination.default','welcome','feed::atom','feed::json','feed::links',
'feed::rss','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
