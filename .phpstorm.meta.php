...
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','ide-helper.filename',
...
'auth.show-set-password','auth.store-set-password','profile.show-settings','profile.update-settings','theme.toggle',
'storage.local',);
        registerArgumentsSet('views', 
'components.form','components.layout','components.primary-nav-items','login','set-password',
'settings','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
