...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/sorokya/Projects/leek.cafe/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/sorokya/Projects/leek.cafe/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'welcome','sitemap','feeds.main','health',
...
'posts.store','posts.show','posts.edit','posts.delete-confirm','posts.destroy',
'posts.update','posts.upload-images','projects.index','projects.create','projects.store',
'projects.show','projects.edit','projects.delete-confirm','projects.destroy','projects.update',
'projects.upload-images','thoughts.index','media.index','theme.toggle','image.serve-thumbnail',
...
'components.status-pill','components.visibility-select','errors.400','errors.403','errors.404',
'errors.500','login','media.index','pagination::default','post.create',
'post.delete-confirm','post.edit','post.index','post.show','project.create',
'project.delete-confirm','project.edit','project.index','project.show','set-password',
'settings','thoughts.index','vendor.pagination.default','welcome','feed::atom',
