...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'media.max_upload_kilobytes' => 'integer',
            'media.max_video_duration_seconds' => 'integer',
            'media.ffprobe_timeout_seconds' => 'integer',
            'media.ffmpeg_timeout_seconds' => 'integer',
            'media.h264_crf' => 'integer',
            'media.audio_bitrate' => 'string',
...
'database.redis.cache.max_retries','database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','feed.feeds.main.items',
'feed.feeds.main.url','feed.feeds.main.title','feed.feeds.main.description','feed.feeds.main.language','feed.feeds.main.image',
'feed.feeds.main.format','feed.feeds.main.view','feed.feeds.main.type','feed.feeds.main.contentType','filesystems.default',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','media.max_upload_kilobytes',
'media.max_video_duration_seconds','media.ffprobe_timeout_seconds','media.ffmpeg_timeout_seconds','media.h264_crf','media.audio_bitrate',
...
'generated::IPTNFqjnhZZSchLF','welcome','sitemap','feeds.main','health',
'auth.show-login','auth.store-login','auth.logout','auth.show-set-password','auth.store-set-password',
'profile.show-settings','profile.update-settings','media-statuses.store','media-statuses.update','media-statuses.destroy',
'media-types.store','media-types.update','media-types.destroy','posts.index','posts.create',
'posts.store','posts.upload-images','posts.show','posts.edit','posts.delete-confirm',
'posts.destroy','posts.update','projects.index','projects.create','projects.store',
'projects.upload-images','projects.show','projects.edit','projects.delete-confirm','projects.destroy',
'projects.update','thoughts.index','thoughts.show','thoughts.store','thoughts.update',
'thoughts.destroy','thoughts.upload-images','media.index','theme.toggle','image.serve-thumbnail',
'image.serve','storage.local',);
        registerArgumentsSet('views', 
'components.card','components.form','components.form-card','components.layout','components.primary-nav-items',
'components.status-pill','components.visibility-radio','components.visibility-select','errors.400','errors.403',
'errors.404','errors.500','login','media.index','pagination::default',
'post.create','post.delete-confirm','post.edit','post.index','post.show',
'project.create','project.delete-confirm','project.edit','project.index','project.show',
'set-password','settings','thoughts.index','thoughts.show','vendor.pagination.default',
'welcome','feed::atom','feed::json','feed::links','feed::rss',
...
'HASH_DRIVER','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','DB_CONNECTION',
