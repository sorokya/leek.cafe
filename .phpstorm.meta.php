...
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','feed.feeds.main.items',
'feed.feeds.main.url','feed.feeds.main.title','feed.feeds.main.description','feed.feeds.main.language','feed.feeds.main.image',
'feed.feeds.main.format','feed.feeds.main.view','feed.feeds.main.type','feed.feeds.main.contentType','sitemap.guzzle_options.cookies',
...
'web','api',);
        registerArgumentsSet('routes', 'welcome','sitemap','health','auth.show-login',
'auth.store-login','auth.logout','auth.show-set-password','auth.store-set-password','profile.show-settings',
'profile.update-settings','media-statuses.store','media-statuses.update','media-statuses.destroy','media-types.store',
'media-types.update','media-types.destroy','posts.index','posts.create','posts.store',
'posts.show','posts.edit','posts.delete-confirm','posts.destroy','posts.update',
'posts.upload-images','theme.toggle','image.serve','storage.local',);
